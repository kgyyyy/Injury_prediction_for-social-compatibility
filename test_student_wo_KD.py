...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("./ckpt/student_wo_KD_best.pth"))

    # Model testing
    HIC_preds, HIC_trues = test(model, test_loader)
    HIC_preds[HIC_preds > 2500] = 2500  # Upper bound: HIC > 2000 indicates critical injury, not meaningful
    ...
    file_path = "./results/student_model_wo_KD_results.md"
    ...
    plt.savefig('results/student_model_wo_KD.png', dpi=300)
    plt.show()
